    ...
    <div className="min-h-screen pt-24 flex items-center justify-center bg-slate-50 dark:bg-slate-950 px-4 transition-colors duration-500">
      <div className="max-w-xl w-full animate-fade-in">
        <div className="text-center mb-8 lg:mb-12">
          ...
          <h1 className="text-3xl sm:text-5xl font-black text-slate-900 dark:text-white tracking-tight">Join the Network</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-3 text-base sm:text-lg font-medium px-4">Contribute to the largest transit directory.</p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 p-8 sm:p-12 lg:p-16 rounded-[40px] sm:rounded-[60px] shadow-[0_40px_80px_-20px_rgba(0,0,0,0.08)] dark:shadow-none border border-slate-100 dark:border-slate-800">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              <div className="space-y-4">
                <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.2em] ml-3">Password</label>
                <div className="relative group">
              ...
              <div className="space-y-4">
                <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.2em] ml-3">Confirm</label>
                <div className="relative group">
                  <Lock className="absolute left-7 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-slate-900 dark:group-focus-within:text-primary-500 transition-colors w-6 h-6" />
                  <input 
                    required
          ...
          <div className="mt-10 flex flex-col space-y-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-[10px] uppercase tracking-widest">
                <span className="bg-white dark:bg-slate-900 px-6 text-slate-400 font-black">Social Registration</span>
              </div>
            </div>
            ...
            >
              ...
              <span className="text-base sm:text-lg">Register with Google</span>
            </button>
          </div>
          ...
          <div className="mt-12 text-center pt-10 border-t border-slate-50 dark:border-slate-800">
            <p className="text-slate-500 dark:text-slate-400 font-bold">
              ...
              <Link to="/login" className="text-primary-600 dark:text-primary-400 font-black hover:underline ml-2">Sign In</Link>
            </p>
          </div>
        </div>
      </div>
